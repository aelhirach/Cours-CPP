...
void Erreur();
char Menu();
void AfficherListes(const list<string>& l1, const list<string>* pl2,
...
void AfficherListes(const list<string>& l1, const list<string>* pl2,
                    list<string>::const_iterator i1, list<string>::const_iterator i2,
                    list<string>::const_iterator i3) {
	ShowTitle("Listes", '-');
...
int LenCompare(const string& val1, const string& val2){
     ...
     int result = (strlen(val1.c_str())==strlen(val2.c_str())) ?  0 : (strlen(val1.c_str())>strlen(val2.c_str())) ? 1 : -1;
     return result; 
...
bool LenEqual::operator()(const string& val) const{
    return (strlen(val.c_str()) == length); 
}
