...
template<class ItGen, class T>
ItGen find(ItGen it1, ItGen it2, T val);
template<class ItGen,class predicate>
ItGen find_if(ItGen it1, ItGen it2, const predicate& p);
template<class ItGen>
ItGen reverse(ItGen it1, ItGen it2);
template<class ItGen, class Compare>
ItGen bubbelSort(ItGen it1, ItGen it2, Compare c);
template<class ItGen,class Compare>
void quickSort(ItGen it1, ItGen it2, Compare c);
...
int seqCompare(InputIterator1 iterB1,InputIterator1 iterE1,InputIterator2 iterB2, InputIterator2 iterE2,Compare c) {
    int result =0; 
    while((iterB1!=iterE1) || (iterB1!=iterE1)){
        if ((iterB1==iterE1) && (iterB1!=iterE1)) return -1;
        else  if ((iterB1!=iterE1) && (iterB1==iterE1)) return 1;
    ...
    if((iterB1==iterE1) && (iterB1==iterE1)) return 0; 
    else return  result;
