...
public:
	...
	const double& operator[](unsigned i) const; /// right value must be consant ... we need just the value without change it 
	double& operator[](unsigned i); /// overlanding operator :: return a l-value(reference of object) in order to be able to change value 
